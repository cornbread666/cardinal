...
function ni(e, n, t, r) {
  if (Fr) {
    var l = fo(e, n, t, r);
    if (l === null) Dl(e, n, r, jr, t), Gi(e, r);
...
function Hs(e) {
  if (e.propertyName === "value" && ll(Ut)) {
    var n = [];
    Vs(n, Ut, e, Jo(e)), Es(If, n);
  }
}
function Ff(e, n, t) {
  e === "focusin"
    ? (ou(), (Nt = n), (Ut = t), Nt.attachEvent("onpropertychange", Hs))
    : e === "focusout" && ou();
}
function jf(e) {
...
function hi(e, n) {
  switch ((I(Wt, n), I(Ht, e), I(Ue, bt), (e = n.nodeType), e)) {
    case 9:
    case 11:
...
function xa(e, n, t) {
  return Pn & 21
    ? (Me(t, n) || ((t = Ts()), (A.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function Ru(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    Pr(e, n), Ta(n, t, r), _o(n, t, r, l), (r = !0);
  else if (e === null) {
    var i = n.stateNode,
      u = n.memoizedProps;
    i.props = u;
...
function Va(e) {
  ...
  n !== null && ((e.alternate = null), Va(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[Bt], delete n[wo], delete n[Jf], delete n[qf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
qa = function (e, n, t) {
  ...
  else (ce = !1), U && n.flags & 1048576 && ta(n, Hr, n.index);
...
ks = Pi;
Ss = Tn;
var Rd = { usingClientEntryPoint: !1, Events: [qt, Un, il, gs, ws, Pi] },
  yt = {
...
function Id() {
  return Jn("div", {
    className:
      "navbar bg-base-100 text-neutral border-b-4 border-accent sticky top-0 z-20",
    children: [
      M("div", { className: "navbar-start" }),
      M("div", {
        className: "navbar-center",
        children: M("h1", {
          className: "text-2xl",
          children: "cornbread.games",
        }),
      }),
      M("div", { className: "navbar-end" }),
    ],
  });
}
function gt({ name: e, gif: n, desc: t, link: r }) {
  const l = (o) => {
    var i;
    (i = window.open(o, "_blank", "noreferrer")) == null || i.focus();
  };
  return Jn("div", {
    className:
      "card card-bordered border-black border-2 rounded-none shadow-card max-w-prose bg-base-100 cursor-pointer mx-10 mt-10 z-10",
    onClick: () => l(r),
    children: [
      M("figure", { children: M("img", { src: n, alt: e }) }),
      Jn("div", {
        className: "card-body",
        children: [
          M("h2", { className: "card-title", children: e }),
          M("p", { children: t }),
        ],
      }),
    ],
...
function Dd() {
  return M("div", {
    className: "hero max-w-prose bg-base-100 my-10",
    children: M("div", {
      className: "hero-content flex-col lg:flex-row-reverse",
      children: Jn("div", {
        className: "text-center lg:text-left mx-10",
        children: [
          M("h1", { className: "text-5xl font-bold", children: "Hello!" }),
          Jn("p", {
            className: "py-6",
            children: [
              "I'm Connor, a Brooklyn-based creator. Thanks for taking the time to check out cornbread.games, my personal site where I put my coding projects.",
              M("br", {}),
              M("br", {}),
              ...
              M("a", {
                ...
                href: "https://www.linkedin.com/in/connorcorde/",
                target: "_blank",
                children: "LinkedIn",
              }),
              M("br", {}),
              M("a", {
                className: "link link-accent",
                href: "https://github.com/cornbread666",
                target: "_blank",
                children: "GitHub",
              }),
            ],
...
const Fd = "assets/cardinal-bff80343.gif",
  jd = "assets/pixelfight-2c4ba081.gif",
  Ud = "assets/tangleroot-909430fa.gif",
  $d = "assets/tumbleweed-6823e1e6.gif",
  Ad = "assets/cardinal_app-ffb898af.png";
function Vd() {
  return Jn("main", {
